...
class RawDataHandler:
    ...
    def GROUPED_ARCHETYPE_HISTORY_FRAME(self):
        ...
        if self._GROUPED_ARCHETYPE_HISTORY_FRAME is None:
            self.gen_hist()
    ...
    def SINGLE_ARCHETYPE_HISTORY_FRAME(self):
        ...
        if self._SINGLE_ARCHETYPE_HISTORY_FRAME is None:
            self.gen_hist()
    ...
    def GROUPED_ARCHETYPE_SUMMARY_FRAME(self):
        ...
        if self._GROUPED_ARCHETYPE_SUMMARY_FRAME is None:
            self.gen_summary()
    ...
    def SINGLE_ARCHETYPE_SUMMARY_FRAME(self):
        ...
        if self._SINGLE_ARCHETYPE_SUMMARY_FRAME is None:
            self.gen_summary()
