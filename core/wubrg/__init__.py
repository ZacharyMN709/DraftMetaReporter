...
from_consts = ['WUBRG', 'FAILSAFE', 'COLOR_COMBINATIONS',
               'COLOR_SINGLES', 'COLOR_PAIRS', 'COLOR_TRIPLES', 'COLOR_QUADRUPLES',
...
from_sorting = ['wubrg_compare_key', 'order_by_wubrg', 'pentad_compare_key', 'order_by_pentad',
                'ColorSortStyles', 'color_filter']
