...
# TODO: Rename 'WUBRG' to 'wubrg' to conform to PEP conventions.
...
from WUBRG.funcs import is_color_string, get_color_string, get_color_identity, get_color_supersets, get_color_subsets
...
from WUBRG.sorting import order_by_wubrg, order_by_pentad, index_dist_wubrg, index_dist_pentad
