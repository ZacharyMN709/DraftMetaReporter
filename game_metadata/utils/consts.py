...
TYPES = {"Land", "Creature", "Artifact", "Enchantment", "Planeswalker", "Instant", "Sorcery", "Tribal"}

# Various Subtypes
LAND_SUBTYPES = {"Plains", "Island", "Swamp", "Mountain", "Forest", "Desert", "Gate", "Lair", "Locus",
                 "Urza's", "Mine", "Power-Plant", "Tower"}

CREATURE_SUBTYPES = {"Advisor", "Aetherborn", "Ally", "Angel", "Antelope", "Ape", "Archer", "Archon", "Army",
                     ...
                     "Fish", "Flagbearer", "Fox", "Fractal", "Frog", "Fungus", "Gargoyle", "Germ", "Giant", "Gnoll",
                     ...
                     "Viashino", "Volver", "Wall", "Warlock", "Warrior", "Weird", "Werewolf", "Whale", "Wizard",
                     "Wolf", "Wolverine", "Wombat", "Worm", "Wraith", "Wurm", "Yeti", "Zombie", "Zubera"}

ARTIFACT_SUBTYPES = {"Blood", "Clue", "Contraption", "Equipment", "Food", "Gold", "Fortification", "Treasure",
                     "Vehicle"}

ENCHANTMENT_SUBTYPES = {"Aura", "Cartouche", "Curse", "Rune", "Background", "Class", "Saga", "Shard", "Shrine"}

PLANESWALKER_SUBTYPES = {"Ajani", "Aminatou", "Angrath", "Arlinn", "Ashiok", "Bahamut", "Basri", "Bolas", "Calix",
                         ...
                         "Mordenkainen", "Nahiri", "Narset", "Niko", "Nissa", "Nixilis", "Oko", "Ral", "Rowan",
                         "Saheeli", "Samut", "Sarkhan", "Serra", "Sorin", "Szat", "Tamiyo", "Teferi", "Teyo",
                         "Tezzeret", "Tibalt", "Tyvar", "Ugin", "Venser", "Vivien", "Vraska", "Will", "Windgrace",
                         "Wrenn", "Xenagos", "Yanggu", "Yanling", "Zariel"}

INSTANT_SUBTYPES = {"Adventure", "Arcane", "Trap"}

SORCERY_SUBTYPES = {"Adventure", "Arcane", "Lesson"}

ALL_SUBTYPES = LAND_SUBTYPES | CREATURE_SUBTYPES | ARTIFACT_SUBTYPES | ENCHANTMENT_SUBTYPES | PLANESWALKER_SUBTYPES \
